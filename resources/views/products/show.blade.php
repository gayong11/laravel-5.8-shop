                ...
                <div class="card-body product-info">
                                ...
                                <div class="crowdfunding-info">
                                    ...
                                    <div class="progress-info">
                                        ...
                                        <span class="float-right user-count">
                                            {{ $product->crowdfunding->user_count }}
                                            名支持者
                                        </span>
                                    </div>
                    ...
                    <div class="product-detail">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a href="#product-detail-tab" aria-controls="product-detail-tab" role="tab" data-toggle="tab" aria-selected="true" class="nav-link active">商品详情</a>
                            </li>
                            <li class="nav-item">
