                            ...
                            @foreach($order->items as $index => $item)
                                <tr>
                                    ...
                                    <td class="vertical-middle">
                                        ...
                                        @else
                                            <ul class="rate-area">
                                                <input type="radio" name="reviews[{{$index}}][rating]" value="5" id="5-star-{{$index}}" checked>
                                                <label for="5-star-{{$index}}"></label>

                                                <input type="radio" name="reviews[{{$index}}][rating]" value="4" id="4-star-{{$index}}">
                                                <label for="4-star-{{$index}}"></label>

                                                <input type="radio" name="reviews[{{$index}}][rating]" value="3" id="3-star-{{$index}}">
                                                <label for="3-star-{{$index}}"></label>

                                                <input type="radio" name="reviews[{{$index}}][rating]" value="2" id="2-star-{{$index}}">
                                                <label for="2-star-{{$index}}"></label>

                                                <input type="radio" name="reviews[{{$index}}][rating]" value="1" id="1-star-{{$index}}">
