                    ...
                    <div class="installment-top">
                        <div class="installment-info">
                            ...
                            <div class="line">
                                ...
                                <div class="line-value">￥{{ $installment->total_aomunt }}</div>
                            </div>
                            <div class="line">
                            ...
                            <div class="line">
                                ...
                                <div class="line-value">
                                    {{ \App\Models\Installment::$statusMap[$installment->status] }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="installment-next text-right">
                            ...
                            @else
                                <div>
                                    <span>近期待还:</span>
                                    <div class="value total_amount">￥{{ $nextItem->total }}</div>
                                </div>
                                <div>
                                    <span>截至日期：</span>
                                    <div class="value">
                                        {{$nextItem->due_date->format('Y-m-d')}}
                                    </div>
                                </div>
                                <div class="payment-buttons">
                                    <a href="{{ route('installments.alipay', [$installment->id]) }}" class="btn btn-primary btn-sm">支付宝支付</a>
