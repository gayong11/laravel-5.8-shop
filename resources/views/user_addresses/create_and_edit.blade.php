...
@section('content')
    <div class="row">
        <div class="col-md-10 offset-log-1">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <user-addresses-create-and-edit inline-template>
                        @if($address->id)
                            <form role="form" action="{{ route('user_addresses.update', ['user_address' => $address->id]) }}" method="POST" class="form-horizontal">
                            {{ method_field('PUT') }}
                        @else
                            <form role="form" action="{{ route('user_addresses.store') }}" method="POST" class="form-horizontal">
                        @endif
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{ old('address', $address->address) }}" name="address">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label
                                    class="col-form-label text-md-right col-sm-2">邮编</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label
                                                           class="col-form-label text-md-right col-sm-2">姓名</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label
                                                           class="col-form-label text-md-right col-sm-2">电话</label>
                            <div class="col-sm-9">
